(function (b, a) {
    ...
    isPlainObject: function (b6) {
      ...
      try {
        if (
          ...
          !J.call(b6.constructor.prototype, "isPrototypeOf")
        ) {
          return false;
        }
      } catch (b5) {
  ...
  var m =
    ...
    (function (dd) {
      var cw,
        ...
        c3 = function (e, dm, i) {
          ...
          return dl !== dl || i
            ? dm
            : dl < 0
            ? String.fromCharCode(dl + 65536)
            : String.fromCharCode((dl >> 10) | 55296, (dl & 1023) | 56320);
        };
      try {
          ...
          if ((dy = cP.exec(dt))) {
            if ((dr = dy[1])) {
              if (dv === 9) {
                ...
                if (
                  dl.ownerDocument &&
                  (dq = dl.ownerDocument.getElementById(dr)) &&
                  cD(dl, dq) &&
                  dq.id === dr
                ) {
                  dx.push(dq);
      ...
      function b9(i, e) {
        var dm = e && i,
          dl =
            ...
            i.nodeType === 1 &&
            e.nodeType === 1 &&
            (~e.sourceIndex || cO) - (~i.sourceIndex || cO);
        if (dl) {
          return dl;
        }
        if (dm) {
      ...
      cX = cu.setDocument = function (dl) {
        ...
        dg.getElementsByClassName =
          cN.test(dm.getElementsByClassName) &&
          ce(function (dn) {
        ...
        if (dg.getById) {
          ...
          cm.filter.ID = function (dp) {
            ...
            return function (dr) {
              var dq =
                typeof dr.getAttributeNode !== dc && dr.getAttributeNode("id");
                  ...
                  !!(
                    ...
                    (dr.contains
                      ...
                      : dp.compareDocumentPosition &&
                        dp.compareDocumentPosition(dq) & 16)
                  )
                );
              }
            : function (dp, dn) {
        ...
        cC = e
          ? function (dp, dn) {
              ...
              var dq =
                !dp.compareDocumentPosition - !dn.compareDocumentPosition;
              if (dq) {
                return dq;
              }
              dq =
                (dp.ownerDocument || dp) === (dn.ownerDocument || dn)
                  ? dp.compareDocumentPosition(dn)
                  : 1;
              if (
                dq & 1 ||
                (!dg.sortDetached && dn.compareDocumentPosition(dp) === dq)
              ) {
      ...
      cu.matchesSelector = function (dl, dn) {
        ...
        if (
          ...
          try {
            ...
            if (
              i ||
              dg.disconnectedMatch ||
              (dl.document && dl.document.nodeType !== 11)
            ) {
              return i;
            }
          } catch (dm) {}
      ...
      cu.attr = function (dl, e) {
        ...
        var i = cm.attrHandle[e.toLowerCase()],
          dm =
            i && cM.call(cm.attrHandle, e.toLowerCase())
              ? i(dl, e, !c6)
              : undefined;
        return dm !== undefined
          ? dm
          : dg.attributes || !c6
          ? dl.getAttribute(e)
          : (dm = dl.getAttributeNode(e)) && dm.specified
          ? dm.value
          : null;
      };
      cu.error = function (e) {
          ...
          PSEUDO: function (i) {
            ...
            if (i[3]) {
              ...
              if (
                ...
                cQ.test(dl) &&
                (e = cg(dl, true)) &&
                (e = dl.indexOf(")", dl.length - e) - dl.length)
              ) {
                i[0] = i[0].slice(0, e);
                i[2] = dl.slice(0, e);
              }
        ...
        filter: {
          ...
          CLASS: function (e) {
            ...
            return (
              ...
              ((i = new RegExp("(^|" + co + ")" + e + "(" + co + "|$)")) &&
                b8(e, function (dl) {
                  return i.test(
                    (typeof dl.className === "string" && dl.className) ||
                      (typeof dl.getAttribute !== dc &&
                        dl.getAttribute("class")) ||
                      ""
                  );
                }))
            );
          ...
          ATTR: function (dl, i, e) {
            return function (dn) {
              ...
              return i === "="
                ...
                ? e && dm.indexOf(e) > -1
                : i === "$="
                ? e && dm.slice(-e.length) === e
                : i === "~="
                ? (" " + dm + " ").indexOf(e) > -1
                : i === "|="
                ? dm === e || dm.slice(0, e.length + 1) === e + "-"
                : false;
            };
          },
            ...
            return dp === 1 && dl === 0
              ...
              : function (dy, dw, dB) {
                  var ds,
                    ...
                    dA,
                    dv,
                    dx = dr !== e ? "nextSibling" : "previousSibling",
                    dC = dy.parentNode,
          ...
          PSEUDO: function (dm, dl) {
            var e,
              i =
                cm.pseudos[dm] ||
                cm.setFilters[dm.toLowerCase()] ||
                cu.error("unsupported pseudo: " + dm);
            if (i[c8]) {
              return i(dl);
            }
            if (i.length > 1) {
              e = [dm, dm, "", dl];
              return cm.setFilters.hasOwnProperty(dm.toLowerCase())
                ? ci(function (dq, ds) {
                    var dp,
                      dn = i(dq, dl),
                      dr = dn.length;
            ...
            return function (dl) {
              ...
              do {
                if (
                  (i = c6
                    ? dl.lang
                    : dl.getAttribute("xml:lang") || dl.getAttribute("lang"))
                ) {
                  i = i.toLowerCase();
        ...
        var dl,
          ...
          e = [
            function (dx, dw, i) {
              return (
                (!du && (i || dw !== dk)) ||
                ((dl = dw).nodeType ? ds(dx, dw, i) : dt(dx, dw, i))
              );
            },
          ];
        for (; dn < dq; dn++) {
          if ((dp = cm.relative[dr[dn].type])) {
            ...
            if (dp[c8]) {
              ...
              return cf(
                ...
                dn > 1 &&
                  ch(
                    dr.slice(0, dn - 1).concat({
                      value: dr[dn - 2].type === " " ? "*" : "",
                    })
                  ).replace(cq, "$1"),
                dp,
                dn < dm && c9(dr.slice(dn, dm)),
                dm < dq && c9((dr = dr.slice(dm))),
                dm < dq && ch(dr)
              );
            }
            e.push(dp);
        ...
        if (dq.length === 1) {
          ...
          while (dp--) {
            ...
            if ((ds = cm.find[dv])) {
              if (
                (dr = ds(
                  dl.matches[0].replace(cr, c3),
                  (cZ.test(du[0].type) && cR(e.parentNode)) || e
                ))
              ) {
                du.splice(dp, 1);
                dm = dr.length && ch(du);
      ...
      if (
        ...
        di(b7, function (i, e, dm) {
          ...
          if (!dm) {
            return i[e] === true
              ? e.toLowerCase()
              : (dl = i.getAttributeNode(e)) && dl.specified
              ? dl.value
              : null;
          }
        });
  ...
  bH.fn.extend({
    ...
    is: function (e) {
      return !!aQ(
        this,
        typeof e === "string" && z.test(e) ? bH(e) : e || [],
        false
      ).length;
    },
  });
        ...
        if (i && (i[1] || !b5)) {
          if (i[1]) {
            ...
            bH.merge(
              ...
              bH.parseHTML(
                i[1],
                b5 && b5.nodeType ? b5.ownerDocument || b5 : n,
                true
              )
            );
  ...
  bH.extend({
    dir: function (b5, i, b7) {
      ...
      while (
        b6 &&
        b6.nodeType !== 9 &&
        (b7 === undefined || b6.nodeType !== 1 || !bH(b6).is(b7))
      ) {
        if (b6.nodeType === 1) {
          e.push(b6);
        }
  ...
  bH.fn.extend({
    ...
    closest: function (b8, b7) {
      var b9,
        ...
        e = [],
        ca =
          z.test(b8) || typeof b8 !== "string" ? bH(b8, b7 || this.context) : 0;
      for (; b6 < b5; b6++) {
        for (b9 = this[b6]; b9 && b9 !== b7; b9 = b9.parentNode) {
          if (
            ...
            (ca
              ? ca.index(b9) > -1
              : b9.nodeType === 1 && bH.find.matchesSelector(b9, b8))
          ) {
            e.push(b9);
            break;
          }
  ...
  bH.each(
    {
      ...
      contents: function (e) {
        return bH.nodeName(e, "iframe")
          ? e.contentDocument || e.contentWindow.document
          : bH.merge([], e.childNodes);
      },
    },
    function (e, i) {
  ...
  bH.acceptData = function (b5) {
    ...
    return e !== 1 && e !== 9
      ? false
      : !i || (i !== true && b5.getAttribute("classid") === i);
  };
  var bx = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/,
    aP = /([A-Z])/g;
  ...
  (function () {
    ...
    C.html5Clone =
      n.createElement("nav").cloneNode(true).outerHTML !== "<:nav></:nav>";
    i.type = "checkbox";
    i.checked = true;
    b5.appendChild(i);
  ...
  bH.event = {
    ...
    add: function (b7, cc, ch, b9, b8) {
      ...
      if (!(cb = cd.handle)) {
        cb = cd.handle = function (ck) {
          return typeof bH !== aB && (!ck || bH.event.triggered !== ck.type)
            ? bH.event.dispatch.apply(cb.elem, arguments)
            : undefined;
        };
        cb.elem = b7;
      }
      ...
      while (ci--) {
        ...
        while (b9--) {
          ...
          if (
            ...
            (!b7 || b7 === cg.selector || (b7 === "**" && cg.selector))
          ) {
            b5.splice(b9, 1);
            if (cg.selector) {
              b5.delegateCount--;
    ...
    trigger: function (b5, cc, b8, cj) {
      ...
      if (!cj && !b5.isDefaultPrevented()) {
        if (
          (!cf._default || cf._default.apply(b9.pop(), cc) === false) &&
          bH.acceptData(b8)
        ) {
      ...
      while ((b5 = cc[b8++]) && !e.isPropagationStopped()) {
        ...
        while ((cd = b5.handlers[b7++]) && !e.isImmediatePropagationStopped()) {
          if (!e.namespace_re || e.namespace_re.test(cd.namespace)) {
            ...
            e.data = cd.data;
            b9 = (
              (bH.event.special[cd.origType] || {}).handle || cd.handler
            ).apply(b5.elem, cb);
            if (b9 !== undefined) {
            ...
            for (b8 = 0; b8 < b7; b8++) {
              ...
              if (b9[b5] === undefined) {
                b9[b5] = cb.needsContext
                  ? bH(b5, this).index(cc) >= 0
                  : bH.find(b5, this, null, [cc]).length;
              }
              if (b9[b5]) {
                b9.push(cb);
              }
    ...
    fix: function (b7) {
      ...
      var b5,
        ...
        b8 = this.fixHooks[b6];
      if (!b8) {
        this.fixHooks[b6] = b8 = bL.test(b6)
          ? this.mouseHooks
          : a5.test(b6)
          ? this.keyHooks
          : {};
    ...
    mouseHooks: {
      ...
      filter: function (b6, b5) {
        ...
        if (b6.pageX == null && b5.clientX != null) {
          ...
          b6.pageX =
            b5.clientX +
            ((b8 && b8.scrollLeft) || (e && e.scrollLeft) || 0) -
            ((b8 && b8.clientLeft) || (e && e.clientLeft) || 0);
          b6.pageY =
            b5.clientY +
            ((b8 && b8.scrollTop) || (e && e.scrollTop) || 0) -
            ((b8 && b8.clientTop) || (e && e.clientTop) || 0);
        }
  ...
  bH.Event = function (i, e) {
    ...
    if (i && i.type) {
      ...
      this.isDefaultPrevented =
        i.defaultPrevented ||
        (i.defaultPrevented === undefined && i.returnValue === false)
          ? T
          : Y;
    } else {
      this.type = i;
    ...
    bH.event.special.submit = {
      setup: function () {
        ...
        bH.event.add(this, "click._submit keypress._submit", function (b6) {
          var b5 = b6.target,
            i =
              bH.nodeName(b5, "input") || bH.nodeName(b5, "button")
                ? b5.form
                : undefined;
  ...
  function l(b7, e) {
    var b5,
      ...
      b6 = 0,
      b9 =
        typeof b7.getElementsByTagName !== aB
          ? b7.getElementsByTagName(e || "*")
          : typeof b7.querySelectorAll !== aB
          ? b7.querySelectorAll(e || "*")
          : undefined;
    if (!b9) {
    ...
    return e === undefined || (e && bH.nodeName(b7, e))
      ? bH.merge([b7], b9)
      : b9;
  }
  function bX(e) {
  ...
  function a2(i, e) {
    return bH.nodeName(i, "table") &&
      bH.nodeName(e.nodeType !== 11 ? e : e.firstChild, "tr")
      ? i.getElementsByTagName("tbody")[0] ||
          i.appendChild(i.ownerDocument.createElement("tbody"))
      : i;
  }
  function t(e) {
            ...
            if (!K.test(b9)) {
              ...
              if (!C.tbody) {
                b9 =
                  ci === "table" && !bZ.test(b9)
                    ? cg.firstChild
                    : b6[1] === "<table>" && !bZ.test(b9)
                    ? cg
                    : 0;
                cd = b9 && b9.childNodes.length;
                while (cd--) {
                  if (
                    bH.nodeName((cf = b9.childNodes[cd]), "tbody") &&
  ...
  bH.fn.extend({
      ...
      return aA(
        ...
        function (i) {
          return i === undefined
            ? bH.text(this)
            : this.empty().append(
                ((this[0] && this[0].ownerDocument) || n).createTextNode(i)
              );
        },
        null,
        e,
      ...
      return aA(
        ...
        function (b8) {
          ...
          if (
            typeof b8 === "string" &&
            !am.test(b8) &&
            (C.htmlSerialize || !L.test(b8)) &&
            (C.leadingWhitespace || !b4.test(b8)) &&
            !V[(o.exec(b8) || ["", ""])[1].toLowerCase()]
          ) {
    ...
    domManip: function (cc, ch) {
      ...
      if (
        b5 ||
        (b7 > 1 && typeof cd === "string" && !C.checkClone && bV.test(cd))
      ) {
            ...
            for (b9 = 0; b9 < e; b9++) {
              ...
              if (
                ...
                if (b6.src) {
                  ...
                  bH.globalEval(
                    (b6.text || b6.textContent || b6.innerHTML || "").replace(
                      aN,
                      ""
                    )
                  );
  ...
  function a3(e, b7) {
    var i,
      ...
      b6 =
        a4.getDefaultComputedStyle && (i = a4.getDefaultComputedStyle(b5[0]))
          ? i.display
          : bH.css(b5[0], "display");
    b5.detach();
    return b6;
  ...
  function aZ(b5) {
    ...
    if (!e) {
      ...
      if (e === "none" || !e) {
        aH = (
          aH || bH("<iframe frameborder='0' width='0' height='0'/>")
  ...
  (function () {
    ...
    function e() {
      ...
      if (a4.getComputedStyle) {
        ...
        b5 =
          (
            a4.getComputedStyle(ce, null) || {
              width: "4px",
            }
          ).width === "4px";
        cd = ce.appendChild(n.createElement("div"));
        cd.style.cssText = ce.style.cssText =
        ...
        return aM(
          ...
          i
            ? aw(
                ...
                i,
                C.boxSizing &&
                  bH.css(b7, "boxSizing", false, b6) === "border-box",
                b6
              )
            : 0
        );
  ...
  if (!C.opacity) {
    bH.cssHooks.opacity = {
      get: function (i, e) {
        return aT.test(
          (e && i.currentStyle ? i.currentStyle.filter : i.style.filter) || ""
        )
  ...
  I.prototype = {
    ...
    run: function (b5) {
      ...
      if (this.options.duration) {
        this.pos = i = bH.easing[this.easing](
          b5,
          this.options.duration * b5,
          0,
          1,
      ...
      "*": [
        function (e, b9) {
          var cb = this.createTween(e, b9),
            ...
            i =
              (bH.cssNumber[e] || (ca !== "px" && +b7)) &&
              bI.exec(bH.css(cb.elem, e)),
            b5 = 1,
            b8 = 20;
          if (i && i[3] !== ca) {
            ca = ca || i[3];
  ...
  function f(b5, b9, cc) {
      ...
      b6 = cb.promise({
        ...
        createTween: function (cg, ce) {
          var cf = bH.Tween(
            ...
            cg,
            ce,
            b6.opts.specialEasing[cg] || b6.opts.easing
          );
          b6.tweens.push(cf);
          return cf;
        },
    ...
    return b6
      .progress(b6.opts.progress)
      .done(b6.opts.done, b6.opts.complete)
      .fail(b6.opts.fail)
      .always(b6.opts.always);
  }
  ...
  bH.speed = function (b5, b6, i) {
    ...
    e.duration = bH.fx.off
      ? 0
      : typeof e.duration === "number"
      ? e.duration
      : e.duration in bH.fx.speeds
      ? bH.fx.speeds[e.duration]
  ...
  bH.each(["toggle", "show", "hide"], function (b5, e) {
    ...
    bH.fn[e] = function (i, b8, b7) {
      return i == null || typeof i === "boolean"
        ? b6.apply(this, arguments)
        : this.animate(bG(e, true), i, b8, b7);
    };
  });
  bH.each(
    {
        ...
        get: function (e) {
          ...
          for (; b5 < b9; b5++) {
            ...
            if (
              ...
              (C.optDisabled
                ? !b6.disabled
                : b6.getAttribute("disabled") === null) &&
              (!b6.parentNode.disabled ||
                !bH.nodeName(b6.parentNode, "optgroup"))
            ) {
              ca = bH(b6).val();
              if (b7) {
                return ca;
    ...
    bN.id =
      ...
      bN.coords =
        function (b5, i, b6) {
          var e;
          if (!b6) {
            return (e = b5.getAttributeNode(i)) && e.value !== ""
              ? e.value
              : null;
          }
        };
  ...
  bH.extend({
    ...
    prop: function (b8, b6, b9) {
      ...
      if (b9 !== undefined) {
        return e && "set" in e && (b5 = e.set(b8, b9, b6)) !== undefined
          ? b5
          : (b8[b6] = b9);
      } else {
    ...
    propHooks: {
      tabIndex: {
        get: function (i) {
          ...
          return e
            ? parseInt(e, 10)
            : aI.test(i.nodeName) || (E.test(i.nodeName) && i.href)
            ? 0
            : -1;
        },
      },
  ...
  bH.fn.extend({
    addClass: function (cc) {
      ...
      if (cb) {
        ...
        for (; b8 < b9; b8++) {
          ...
          cd =
            b5.nodeType === 1 &&
            (b5.className ? (" " + b5.className + " ").replace(bK, " ") : " ");
          if (cd) {
            b7 = 0;
            while ((ca = b6[b7++])) {
              if (cd.indexOf(" " + ca + " ") < 0) {
    ...
    hasClass: function (e) {
      ...
      for (; b6 < b5; b6++) {
        if (
          this[b6].nodeType === 1 &&
          (" " + this[b6].className + " ").replace(bK, " ").indexOf(b7) >= 0
        ) {
          return true;
        }
      }
    ...
    ajax: function (b9, b6) {
      ...
      if (cd.crossDomain == null) {
        ...
        cd.crossDomain = !!(
          ...
          (ci[1] !== b3[1] ||
            ci[2] !== b3[2] ||
            (ci[3] || (ci[1] === "http:" ? "80" : "443")) !==
              (b3[3] || (b3[1] === "http:" ? "80" : "443")))
        );
      }
      ...
      if (
        (cd.data && cd.hasContent && cd.contentType !== false) ||
        b6.contentType
      ) {
      ...
      cj.setRequestHeader(
        "Accept",
        cd.dataTypes[0] && cd.accepts[cd.dataTypes[0]]
          ? cd.accepts[cd.dataTypes[0]] +
              (cd.dataTypes[0] !== "*" ? ", " + aW + "; q=0.01" : "")
          : cd.accepts["*"]
      );
  ...
  bH.expr.filters.hidden = function (e) {
    return (
      ...
      (!C.reliableHiddenOffsets() &&
        ((e.style && e.style.display) || bH.css(e, "display")) === "none")
    );
  };
      ...
      b8 =
        ...
        (a7.test(b6.url)
          ...
          : typeof b6.data === "string" &&
            !(b6.contentType || "").indexOf(
              "application/x-www-form-urlencoded"
            ) &&
            a7.test(b6.data) &&
            "data");
    if (b8 || b6.dataTypes[0] === "jsonp") {
      b9 = b6.jsonpCallback = bH.isFunction(b6.jsonpCallback)
        ? b6.jsonpCallback()
        : b6.jsonpCallback;
      if (b8) {
  ...
  bH.fn.extend({
    ...
    offsetCustom: function (i) {
      ...
      b8 = bq(b7);
      return {
        top: b6.top + e.scrollTop - (e.clientTop || 0),
        left: b6.left + e.scrollLeft - (e.clientLeft || 0),
      };
    },
    position: function () {
      if (!this[0]) {
